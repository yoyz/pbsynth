...
SynthEngine::SynthEngine(int samplesPerTick, long max_delaylen) {
	...
	oscillators[0] = new Oscillator();
	oscillators[1] = new Oscillator();
...
Oscillator *SynthEngine::getOscillator(int i) {
...
Filter *SynthEngine::getFilter(int i) {
...
int SynthEngine::getFilter24dB() {

	return parameters.filter_24db;
}

void SynthEngine::setFilter24dB(int i) {
